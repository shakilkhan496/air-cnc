...
const Login = () => {
  ...
  const handleResetPassword = () => {
    resetPassword(userEmail)
      .then(() => {
        toast.success('please check your email form password reset');
        setLoading(false)
      })
      .catch(e => console.log(e))
  }
    ...
    <div className='flex justify-center items-center pt-8'>
      <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900'>
        ...
        <div className='flex justify-center space-x-4'>
          <button onClick={handleGoogleLogin} aria-label='Log in with Google' className='p-3 focus:scale-90 cursor-crosshair hover:scale-110 transition rounded-sm'>
            <svg
